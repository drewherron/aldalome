...
(aldalome-with-color-variables
  (custom-theme-set-faces
   ...
   `(org-meta-line ((t (:foreground ,alda-lgray))))
   `(org-latex-and-related ((t (:foreground ,alda-fg))))
   ...
   `(org-ellipsis ((t (:foreground ,alda-fg))))
   `(org-warning ((t (:foreground ,alda-fg))))
   `(org-date-selected ((t (:foreground ,alda-bg :background ,alda-fg))))
   `(org-scheduled ((t (:foreground ,alda-fg))))
   `(org-scheduled-today ((t (:foreground ,alda-fg))))
   ...
   ;; eww
   `(shr-link ((t (:foreground ,alda-fg :underline t))))
   ;; elfeed
